...
public class BackgroundReporter {
     ...
     *
     * <p>Reports are rate-limited to one identical (same host, error and certificate chain) report
     ...
     */
    @RequiresApi(api = 16)
    public void pinValidationFailed(
        ...
        PinningFailureReport report =
                new PinningFailureReport(
                        ...
                        serverConfig.shouldIncludeSubdomains(),
                        serverConfig.shouldEnforcePinning(),
                        servedCertificateChainAsPem,
                        validatedCertificateChainAsPem,
    ...
    protected void sendReport(
            @NonNull PinningFailureReport report, @NonNull Set<URL> reportUriSet) {
