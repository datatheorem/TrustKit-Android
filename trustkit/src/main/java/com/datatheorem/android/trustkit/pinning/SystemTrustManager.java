...
public class SystemTrustManager {
     ...
     * manager will consecutively do path validation (all API levels), hostname validation (API
     * level 16 to ???), and pinning validation if a network policy was configured (API level 24+).
     *
