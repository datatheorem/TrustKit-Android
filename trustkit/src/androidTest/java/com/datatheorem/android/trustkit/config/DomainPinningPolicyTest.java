...
public class DomainPinningPolicyTest {
    ...
    private static final Set<String> reportUris = new HashSet<>();
    ...
    public void testValidPolicy() throws MalformedURLException {
        ...
        DomainPinningPolicy policy =
                new DomainPinningPolicy("www.test.com", true, pins, true, date, reportUris, false);
